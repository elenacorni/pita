...
require "${startPath}/lib/libfile.pl";
...
while(@ARGV)
{
  ...
  {
    die("${startPath}/lib/body.pl: Bad argument '$arg' given.  Use --help for help.");
  }
}
...
{
   $tmp_file = 'tmp_' . time . '.' . rand() . '.${startPath}/lib/body.pl';
...
__DATA__
Syntax: ${startPath}/lib/body.pl BEG END < FILE
...
-f:               Allow giving BEG and END as fractions of number of lines in file (for example ${startPath}/lib/body.pl 4 -0.2)
