...
require "/home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/load_args.pl";
...
{
	dsystem ("cat $utr_fn | /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/dos2unix.pl | /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/fasta2stab.pl > tmp_utr_stab_$r");
	dsystem ("cat $mir_fn | /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/dos2unix.pl | /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/fasta2stab.pl > tmp_mir_stab_$r");
}
...
if ($upstream_fn eq "")
{
	dsystem ("cat tmp_utr_stab_$r " .
			 "| cut -f 1 " .
			 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/add_column.pl -s $POLY_A " .
			 "> tmp_prefix_$r;");
}
else
{
	...
	{
		dsystem ("cat $upstream_fn | /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/fasta2stab.pl > tmp_upstream_stab_$r");
	}
	
	dsystem ("cat tmp_utr_stab_$r " .
			 "| cut -f 1 " .
			 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/add_column.pl -s $POLY_A " .
			 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/join.pl -o A - tmp_upstream_stab_$r " .
			 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/merge_columns.pl -1 1 -2 2 " .
			 "> tmp_ext_utr_$r;");
	
	dsystem ("cat tmp_ext_utr_$r " .
			 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/stab2length.pl " .
			 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/cut.pl -f 1,1,2,2 " .
			 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/modify_column.pl -c 2 -s " . ($CDS_FLANK-1) . " " .
			 ">tmp_ext_utr_pos_$r");
			 
	dsystem ("cat tmp_ext_utr_$r " .
			 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/extract_sequence.pl -f tmp_ext_utr_pos_$r " .
			 "> tmp_prefix_$r");
}

my $ext_utr_fn = $output_dir . $prefix . "ext_utr.stab";

dsystem ("/home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/join.pl tmp_prefix_$r tmp_utr_stab_$r " .
         "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/add_column.pl -s $POLY_A " .
         "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/merge_columns.pl -1 1 -2 2 " .
         "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/merge_columns.pl -1 1 -2 2 " .
         "> " . $ext_utr_fn);
...
dsystem ("/home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/find_potential_mirna_targets.pl tmp_utr_stab_$r -f tmp_mir_stab_$r $echoed_pt_args > tmp_pt_$r");
...
dsystem ("cat tmp_pt_$r " .
		 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/join.pl -1 2 - $ext_utr_fn " .
		 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/cut.pl -f 1-9,11- " .
		 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/modify_column.pl -c 2,3 -a $CDS_FLANK " .
		 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/RNAddG_compute.pl -ddgarea $DDG_AREA -upstream_rest $FLANK_UP -downstream_rest $FLANK_DOWN " .
		 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/modify_column.pl -c 2,3 -s $CDS_FLANK " .
		 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/modify_column.pl -c 9,10,11,12,13,14 -m '\"-1\"' " .
		 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/cut.pl -f 1-15,14 " .
		 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/modify_column.pl -c 15 -sc 14 " .
		 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/cut.pl -f 1-12,14-16,13 " .
		 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/modify_column.pl -c 9,10,11,12,13,14,15 -p 2 -m '\"-1\"' " .
		 "| /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/cap.pl \"UTR,microRNA,Start,End,Seed,Mismatchs,G:U,Loop,Site size,dGduplex,dG5,dG3,dG0,dG1,dGopen,ddG\" " .
...
__DATA__
syntax: /home/HPC/elena.corni/PITA_prog/pita/pita_orig/lib/pita_run.pl [OPTIONS]
