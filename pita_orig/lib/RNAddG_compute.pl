...
require "${startPath}/lib/sequence_helpers.pl";
require "${startPath}/lib/format_number.pl";

my $RNAHYBRID_EXE_DIR = "${startPath}/Bin/RNAHybrid/RNAhybrid-2.1/src";
my $RNAddG_EXE_DIR 		= "${startPath}/Bin/ViennaRNA/ViennaRNA-1.6/Progs/";
...
${startPath}/lib/RNAddG_compute.pl <file>
