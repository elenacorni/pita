...
sub GetNumColumns
{
   ...
   my $rows = `head -1 $file_name | /home/HPC/elena.corni/PITA_prog/pita/pita_c/lib/transpose.pl | wc -l`;
...
sub ExtractFileLinesBetweenRegexps
{
  ...
  if ( $regexp_from eq $regexp_to ) {
    die "(/home/HPC/elena.corni/PITA_prog/pita/pita_c/lib/libfile.pl) ExtractFileLinesBetweenRegexps() - 'from' and 'to' regexps are identical. Give me a break, use grep.\n";
  }
...
sub ExtractAllFileLinesNotBetweenRegexps
{
  ...
  if ( $regexp_from eq $regexp_to ) {
    die "(/home/HPC/elena.corni/PITA_prog/pita/pita_c/lib/libfile.pl) ExtractAllFileLinesNotBetweenRegexps() - 'from' and 'to' regexps are identical. Give me a break, use grep.\n";
  }
