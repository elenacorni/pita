...
require "/home/HPC/elena.corni/PITA_prog/pita/pita_c/lib/libfile.pl";
...
while(@ARGV)
{
  ...
  {
    die("/home/HPC/elena.corni/PITA_prog/pita/pita_c/lib/body.pl: Bad argument '$arg' given.  Use --help for help.");
  }
}
...
{
   $tmp_file = 'tmp_' . time . '.' . rand() . './home/HPC/elena.corni/PITA_prog/pita/pita_c/lib/body.pl';
...
__DATA__
Syntax: /home/HPC/elena.corni/PITA_prog/pita/pita_c/lib/body.pl BEG END < FILE
...
-f:               Allow giving BEG and END as fractions of number of lines in file (for example /home/HPC/elena.corni/PITA_prog/pita/pita_c/lib/body.pl 4 -0.2)
